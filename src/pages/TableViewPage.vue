<template>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12" style="float:left;padding-top:10px;" v-if="dataSets">
                <div class="card">
        ...
        methods: {
            getData() {
                ...
                self.populationService.getCountryPopulationData().then(data => {
                     console.log(data);
                      self.dataSets = data; 
                      if(self.dataSets && self.dataSets.length && self.dataSets.length>0) {
                        //var lbl =  Object.keys(self.dataSets[0]);
                        self.sortkey = 'name';
